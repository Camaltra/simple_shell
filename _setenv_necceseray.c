...
/**
* _setenv_exist - Get the env variable index, then malloc a
...
/**
* _setenv_not_exist - Malloc a new place at the end of all
...
int _setenv_not_exist(void)
{
	...
	for (i = 0; new_env[i]; i++)
		;
	new_env = _realloc_pointer(new_env, sizeof(char *) * (i + 2));
	if (!new_env)
		_exit_();
	new_env[i + 1] = NULL;
	return (i);
...
/**
* init_new_env - init a new env variable
*
...
/**
* error_setenv - Printf the correct syntaxe of setenv
*
